...
impl <'a> Control<'a> {
    pub fn new(reg: &'a [u8; 0x40], raster_interrupt_at_line: u16) -> Self {
        Control { reg, raster_interrupt_at_line }
    }
    pub fn get_sprite_coordinate(&self, sprite_no: u8, coordinate: Coordinate) -> u16 {
    ...
    pub fn get_screen_height(&self) -> u8 {
